...
Este directorio concentra la documentacion de producto, tecnica y de produccion para llevar `El Monstruo de la Laguna` desde el prototipo actual hasta un juego completo.
...
- [Arte y Audio](./arte-y-audio.md)
- [Backlog Priorizado](./backlog-priorizado.md)
- [Milestones de Trabajo](./milestones-de-trabajo.md)
- [Plan de Implementacion](./plan-de-implementacion.md)
...
- `Arquitectura Propuesta` baja el problema a modulos, datos y responsabilidades.
- `Arte y Audio` fija inventario de assets y lineamientos visuales.
- `Milestones de Trabajo` agrupa el backlog en entregas concretas.
- `Backlog Priorizado` convierte el plan en trabajo ejecutable.
- `Plan de Implementacion` funciona como documento resumen.

## Orden sugerido de ejecucion

- P0: base tecnica, sistema de niveles, jugador, HUD minimo
- P1: coleccionables, progresion, enemigos y plataformas especiales
- P2: menus, pulido visual, audio y balance
...
- Que assets hacen falta
- En que orden conviene construir el juego
